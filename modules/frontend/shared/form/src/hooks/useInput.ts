import { FormState, Resolver, ValidationMode, UseFormRegister } from "react-hook-form";
...
export function useGetInputs<FormData>(inputsConfig: InputConfig<FormData>, formConfig: FormConfig<FormData>): GetInputs<FormData> {
...
export const getUseFormConfig = <FormData>(formConfig: FormConfig<FormData>) : {
