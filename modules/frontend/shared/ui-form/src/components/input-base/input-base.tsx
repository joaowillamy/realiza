import { FormControlProps, InputGroup, InputLeftElement, InputRightElement } from '@chakra-ui/react';
  ...
  return (
    <S.Wrapper {...rest}>
      ...
      <InputGroup>
        ...
        {children}
        {rightElement && <InputRightElement children={rightElement} width="3.5rem" />}
      </InputGroup>
